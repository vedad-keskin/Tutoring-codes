    ...
    public partial class frmGradoviIB180079 : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            if (Validiraj())
            {
                ...
                {
                    MessageBox.Show("Grad je već dodan u državi", "Upozorenje", MessageBoxButtons.OK, MessageBoxIcon.Warning);
                }
                else
                {
        ...
        private void GenerisiGradove()
        {
            ...
            for (int i = 0; i < broj; i++)
            {
                ...
                info += $"{DateTime.Now.ToString("dd.MM HH:mm:ss")} -> " +
                    $"dodat grad {noviGrad.Naziv} za državu {odabranaDrzava.Naziv} {Environment.NewLine}";
