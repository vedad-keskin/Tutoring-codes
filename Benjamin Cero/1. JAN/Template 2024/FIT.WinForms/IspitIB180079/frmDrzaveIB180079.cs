...
namespace FIT.WinForms.IspitIB180079
{
    public partial class frmDrzaveIB180079 : Form
    {
        ...
        private void UcitajDrzave()
        {
            ...
            // drzave[0] = BiH -> Broj --> Mos Jab -> 2
            // drzave[1] = Nov -> Broj --> Oslo -> 1
            // drzave[2] = Sve -> Broj --> Mal -> 1
        ...
        // svake sekunde se funckiaj pali
        ...
        private void dgvDrzave_CellDoubleClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            var odbranaDrzava = drzave[e.RowIndex];
            //var odabranaDrzava2 = dgvDrzave.SelectedRows[0].DataBoundItem as DrzaveIB180079;


            if (e.ColumnIndex < 4)
            {
                frmNovaDrzavaIB180079 frmModifikacija = new frmNovaDrzavaIB180079(odbranaDrzava);
