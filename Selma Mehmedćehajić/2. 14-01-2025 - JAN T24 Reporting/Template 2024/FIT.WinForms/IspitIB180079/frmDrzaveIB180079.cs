...
namespace FIT.WinForms.IspitIB180079
{
    public partial class frmDrzaveIB180079 : Form
    {
        ...
        {
            var frmNovaDrava = new frmNovaDrzavaIB180079();


            if (frmNovaDrava.ShowDialog() == DialogResult.OK)
            {
                UcitajDrzave();
                MessageBox.Show("Država je uspješno dodana", "Informacija", MessageBoxButtons.OK, MessageBoxIcon.Information);
            }
        }
        ...
        private void dgvDrzave_CellDoubleClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            if (e.ColumnIndex < 4)
            {
                ...
                {
                    UcitajDrzave();
                    MessageBox.Show("Država je uspješno uređena", "Informacija", MessageBoxButtons.OK, MessageBoxIcon.Information);
                }
            }
