...
namespace FIT.WinForms.IspitIB180079
{
    public partial class frmProstorijeIB180079 : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            {
                UcitajProstorije();
                MessageBox.Show("Dodali ste prostoriju", "Informacija", MessageBoxButtons.OK, MessageBoxIcon.Information);
            }
        }
        ...
        private void dgvProstorije_CellDoubleClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            //var odabrana = dgvProstorije.SelectedRows[0].DataBoundItem as ProstorijeIB180079;
            ...
            if (e.ColumnIndex < 5)
            {
                ...
                {
                    UcitajProstorije();
                    MessageBox.Show("Modifikovali ste prostoriju", "Informacija", MessageBoxButtons.OK, MessageBoxIcon.Information);
                }
        ...
        {
            var odabranaPostorija = dgvProstorije.SelectedRows[0].DataBoundItem as ProstorijeIB180079;

            frmIzvjestaji frmIzvjestaj = new frmIzvjestaji(odabranaPostorija);
