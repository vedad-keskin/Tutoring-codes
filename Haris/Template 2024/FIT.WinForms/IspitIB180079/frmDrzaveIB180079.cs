...
namespace FIT.WinForms.IspitIB180079
{
    public partial class frmDrzaveIB180079 : Form
    {
        ...
        private void dgvDrzave_CellDoubleClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            // var odabranaDrzava2 = dgvDrzave.SelectedRows[0].DataBoundItem as DrzaveIB180079;
            ...
            if (e.ColumnIndex < 4)
            {
                ...
                {
                    UcitajDrzave();
                    MessageBox.Show("Drzava se modifikovala");
                }
            }
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            if (gradoviOdabraneDrzave.Count() != 0)
            {

                frmIzvjestaji frmIzvjestaj = new frmIzvjestaji(gradoviOdabraneDrzave);
                frmIzvjestaj.ShowDialog();

            }
            else
            {
                MessageBox.Show("Država nema gradova");
            }


        }

        private void btnNovaDrzava_Click_1(object sender, EventArgs e)
        {
            frmNovaDrzavaIB180079 frmNova = new frmNovaDrzavaIB180079();
            if (frmNova.ShowDialog() == DialogResult.OK)
            {
                UcitajDrzave();
                MessageBox.Show("Drzava se dodala");
            }
        }
    }
}
