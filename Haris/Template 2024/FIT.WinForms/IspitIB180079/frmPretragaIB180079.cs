...
namespace FIT.WinForms.IspitIB180079
{
    public partial class frmPretragaIB180079 : Form
    {
        ...
        private void UcitajStudente()
        {
            ...
            {
                studenti[i].DrzavaInfo = studenti[i].Grad.Drzava.Naziv;
            ...
            if(studenti.Count() == 0)
            {
                MessageBox.Show($"U bazi nije evidentiran niti jedan student rođen u gradu {odabraniGrad}, {odabranaDrzava}","Upozorenje",MessageBoxButtons.OK,MessageBoxIcon.Exclamation);
            }
