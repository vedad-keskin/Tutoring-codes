        ...
        private void btnSacuvaj_Click(object sender, EventArgs e)
        {
            ...
            if (ValidirajUnos())
            {
                ...
                if(broj <= 0)
                {
                    ...
                    MessageBox.Show("Broj ne smije biti 0 ili negativan", "Upozorenje", MessageBoxButtons.OK, MessageBoxIcon.Warning);
                ...
                && x.Autor.ToLower() == autor.ToLower()))
                {
                    ...
                    MessageBox.Show($"Knjiga {naziv} autora {autor} je već dodana u bazu","Upozorenje",MessageBoxButtons.OK,MessageBoxIcon.Warning);
