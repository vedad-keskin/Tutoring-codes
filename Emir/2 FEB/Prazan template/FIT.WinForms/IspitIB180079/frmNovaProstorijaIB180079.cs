...
namespace FIT.WinForms.IspitIB180079
{
    public partial class frmNovaProstorijaIB180079 : Form
    {
        ...
        private ProstorijeIB180079 odabranaProstorija; // ako otvaramo preko dft. constr. odabranaPr. ne postoji (null) 


        // dft. constr. --> za dodvanje nove prostorije
        public frmNovaProstorijaIB180079()
        {
            InitializeComponent();
        }

        // user. def. constr. --> editovanje postojece prostorije
