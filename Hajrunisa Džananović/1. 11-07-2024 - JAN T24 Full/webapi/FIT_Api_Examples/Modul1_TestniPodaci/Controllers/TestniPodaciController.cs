...
namespace FIT_Api_Examples.Modul1_TestniPodaci.Controllers
{
    ...
    public class TestniPodaciController : ControllerBase
    {
        ...
        public ActionResult Generisi()
        {
            ...
            nastavnici.Add(new Nastavnik { ime = "Denis", prezime = "Music", korisnickoIme = "denis", lozinka = "test", slika_korisnika= Config.SlikeURL + "empty.png", DefaultOpstina = opstine[2] });
            nastavnici.Add(new Nastavnik { ime = "Emina", prezime = "Junuz", korisnickoIme = "emina", lozinka = "test", slika_korisnika = Config.SlikeURL + "empty.png", DefaultOpstina = opstine[2] });
            nastavnici.Add(new Nastavnik { ime = "Iris", prezime = "Memic-Fisic", korisnickoIme = "iris", lozinka = "test", slika_korisnika = Config.SlikeURL + "empty.png", isProdekan=true, DefaultOpstina = opstine[2] });
            nastavnici.Add(new Nastavnik { ime = "Nina", prezime = "Bijedic", korisnickoIme = "nina", lozinka = "test", slika_korisnika = Config.SlikeURL + "empty.png", isDekan = true, DefaultOpstina = opstine[2] });
            nastavnici.Add(new Nastavnik { ime = "Adil", prezime = "Joldic", korisnickoIme = "adil", lozinka = "test", slika_korisnika = Config.SlikeURL + "empty.png", isAdmin=true, DefaultOpstina = opstine[2] });
