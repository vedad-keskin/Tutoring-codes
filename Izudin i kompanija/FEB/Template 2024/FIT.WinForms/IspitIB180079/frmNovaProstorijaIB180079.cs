...
namespace FIT.WinForms.IspitIB180079
{
    public partial class frmNovaProstorijaIB180079 : Form
    {
        ...
        private ProstorijeIB180079 odabranaProstorija; // odabranaProstorija ne postoji (null) ako radimo pokrtetanje preko dft. constr.


        // dft. constr. koristi se za dodavanje nove prostorije
        public frmNovaProstorijaIB180079()
        {
            InitializeComponent();
        }

        // usr. def constr. koristi se za editovanje potojece prostorije
        ...
        private void btnSacuvaj_Click(object sender, EventArgs e)
        {
            if (Validiraj())
            {
                ...
                if(odabranaProstorija == null) // dodavanje nove prostorije
                {
        ...
        private void UcitajInfo()
        {
            ...
            if(odabranaProstorija != null) // ako odabranaProstorija postoji/ ako je prosljedjena
            {
