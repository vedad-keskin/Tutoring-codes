...
namespace DLWMS.WinApp.IspitIB180079
{
    public partial class frmPretragaIB180079 : Form
    {
        ...
        private void UcitajStudente()
        {
            ...
            // Zakomentarisano zbog brzeg testiranja

            //if (studenti.Count() == 0)
            //{
            //    MessageBox.Show($"U bazi nisu evidentirani studenti spola {spol}, koji u imenu i prezimenu posjeduju sadržaj {imePrezime}, a koji su državljani {drzava}.", "Upozorenje", MessageBoxButtons.OK, MessageBoxIcon.Information);
            //}
