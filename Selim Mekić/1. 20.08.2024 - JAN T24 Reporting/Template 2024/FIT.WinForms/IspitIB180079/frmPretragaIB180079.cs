    ...
    public partial class frmPretragaIB180079 : Form
    {
        ...
        private void UcitajStudente()
        {
            ...
            studenti = db.Studenti 
                 ...
                 .Where(x => x.GradId == odabraniGrad.Id).ToList();
            ...
            if(studenti.Count() == 0)
            {
                MessageBox.Show($"U bazi nije evidentiran niti jedan student rođen u gradu {odabraniGrad}, {odabranaDrzava} (ako su odabrani navedeni grad i država).","Upozorenje",MessageBoxButtons.OK,MessageBoxIcon.Warning);
            }
