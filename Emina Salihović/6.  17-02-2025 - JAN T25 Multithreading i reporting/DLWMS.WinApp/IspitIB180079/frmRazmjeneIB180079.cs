...
namespace DLWMS.WinApp.IspitIB180079
{
    public partial class frmRazmjeneIB180079 : Form
    {
        ...
        private void GenerisiRazmjene(UniverzitetiIB180079? odabraniUniverzitet)
        {
            ...
            //var broj = int.TryParse(txtBroj.Text, out var result) ? result : 1;
            ...
            for (int i = 0; i < broj; i++)
            {
                ...
                info += $"{i + 1}. razmjena za {odabraniStudent.StudentInfo} na {odabraniUniverzitet} ({datumPocetak.ToString("d")} - {datumKraj.ToString("dd.MM.yyyy")}){Environment.NewLine}";
