...
namespace DLWMS.WinApp.IspitIB180079
{
    public partial class frmStudentEditIB180079 : Form
    {
        ...
        private void UcitajInfo()
        {
            ...
            //cbDrzava.SelectedIndex = db.Drzave.ToList()
            //    .FindIndex(x => x.Id == odabraniStudent.Grad.DrzavaId);
            ...
            //cbGrad.SelectedIndex = gradoviDrzave
            //    .FindIndex(x => x.Id == odabraniStudent.GradId);
        ...
        private void btnSacuvaj_Click(object sender, EventArgs e)
        {
            ...
            // student -> Id BrojIndeksa Ime Prezime Slika GradId = 2 ... 
