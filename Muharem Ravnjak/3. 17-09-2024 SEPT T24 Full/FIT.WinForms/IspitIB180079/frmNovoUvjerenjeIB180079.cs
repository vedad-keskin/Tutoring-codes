    ...
    public partial class frmNovoUvjerenjeIB180079 : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            if (Validiraj())
            {
                ...
                var novoUvjernje = new StudentiUvjerenjaIB180079()
                {
                ...
                db.StudentiUvjerenjaIB180079.Add(novoUvjernje);
                db.SaveChanges();
        ...
        {
            return Validator.ProvjeriUnos(txtSvrha, err, Kljucevi.ReqiredValue) && Validator.ProvjeriUnos(pbUplatnica, err, Kljucevi.ReqiredValue);
        }
    }
}
