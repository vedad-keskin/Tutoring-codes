...
namespace FIT.WinForms.IspitIB180079
{
    public partial class frmNastavaIB180079 : Form
    {
        ...
        private void btnDodaj_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("Nastava je već zakazana na tom terminu","Upozorenje",MessageBoxButtons.OK,MessageBoxIcon.Warning);
            }
            else
            {
                ...
                {
                    // Id = 1 puca baaz
                    // Predmet = predmet baza puca
                    // Prostorija = odabranaProstorija baza puca
