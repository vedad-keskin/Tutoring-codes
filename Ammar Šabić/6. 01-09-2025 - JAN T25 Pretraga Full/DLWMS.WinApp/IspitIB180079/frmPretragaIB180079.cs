...
namespace DLWMS.WinApp.IspitIB180079
{
    public partial class frmPretragaIB180079 : Form
    {
        ...
        private void UcitajStudente()
        {
            ...
            var drzava = cbDrzava.SelectedItem as Drzava ?? new Drzava(); // null 

            var imePrezime = txtImePrezime.Text.ToLower() ?? string.Empty; // Emina -> emina
            ...
            studenti = db.Studenti
                ...
                .Where(x => x.Ime.ToLower().Contains(imePrezime) || x.Prezime.ToLower().Contains(imePrezime)) // emina == emina
            ...
            if(studenti.Count() == 0 && drzava.Id != 0  && spol.Id != 0)
            {
