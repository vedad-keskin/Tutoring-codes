    ...
    public partial class frmStipendijeIB180079 : Form
    {
        ...
        private void btnDodaj_Click(object sender, EventArgs e)
        {
            ...
            if (Validiraj())
            {
                ...
                {
                    MessageBox.Show($"Stipendija {stipendija} je već evidentirana unutar {godina} godine", "Upozorenje", MessageBoxButtons.OK, MessageBoxIcon.Warning);
                }
                else
                {
        ...
        private void dgvStipendijeGodine_CellDoubleClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            stipendijaGodina.Aktivan = !stipendijaGodina.Aktivan;


            db.StipendijeGodineIB180079.Update(stipendijaGodina);
            db.SaveChanges();
        ...
        private async void btnGenrisi_Click(object sender, EventArgs e)
        {
        ...
        private void GenerisiStipendije()
        {
            ...
            Action action = () =>
            {
                ...
                MessageBox.Show($"Generisanje je uspješno odrađeno", "Informacija", MessageBoxButtons.OK, MessageBoxIcon.Information);
