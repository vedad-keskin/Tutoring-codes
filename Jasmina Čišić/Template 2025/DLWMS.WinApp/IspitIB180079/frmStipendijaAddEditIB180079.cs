    ...
    public partial class frmStipendijaAddEditIB180079 : Form
    {
        ...
        private void btnSacuvaj_Click(object sender, EventArgs e)
        {
            ...
            if (Validiraj())
            {
                ...
                {
                    MessageBox.Show($"Student {student} već ima evidentiranu stipendiju {stipendijaGodina}","Upozorenje",MessageBoxButtons.OK,MessageBoxIcon.Warning);
                }
                else
                {
