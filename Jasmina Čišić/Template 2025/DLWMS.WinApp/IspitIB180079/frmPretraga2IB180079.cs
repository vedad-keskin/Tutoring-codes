...
namespace DLWMS.WinApp.IspitIB180079
{
    public partial class frmPretraga2IB180079 : Form
    {
        ...
        private void UcitajStudente()
        {
            ...
            var imeprezime = txtImePrezime.Text.ToLower(); // EMINA --> emina

            var aktivan = chbAktivan.Checked; // true -> checked , false -> unchekced
            ...
            var studenti = db.Studenti
                ...
                x.Prezime.ToLower().Contains(imeprezime)) // emina emina
