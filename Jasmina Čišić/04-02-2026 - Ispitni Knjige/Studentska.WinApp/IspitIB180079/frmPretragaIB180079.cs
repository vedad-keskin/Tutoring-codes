...
namespace Studentska.WinApp.IspitIB180079
{
    public partial class frmPretragaIB180079 : Form
    {
        ...
        private void UcitajStudentiKnjige()
        {
            ...
            var pretraga = txtPretraga.Text.ToLower(); // BAZE -- baze -- BAZe --> baze
            ...
            var studentiKnjige = studentiKnjigeServis
                ...
                $"{x.Student.Ime} {x.Student.Prezime}".ToLower().Contains(pretraga)) // Baze -> baze
        ...
        private void btnDodaj_Click(object sender, EventArgs e)
        {
            ...
            var frmDodajKnjigu = new frmKnjigaAddIB180079();

            if (frmDodajKnjigu.ShowDialog() == DialogResult.OK)
            {
                UcitajStudentiKnjige();
            }
