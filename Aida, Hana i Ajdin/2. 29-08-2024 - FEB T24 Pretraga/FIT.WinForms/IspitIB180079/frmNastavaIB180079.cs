...
namespace FIT.WinForms.IspitIB180079
{
    public partial class frmNastavaIB180079 : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("Nastava je već evidenitrana na tom terminu", "Upozorenje", MessageBoxButtons.OK, MessageBoxIcon.Warning);
            }
            else
            {
                var novaNastava = new NastavaIB180079()
                {
                    // Id = 1, id je autoinc i ne moze se pohranjivati
                    // Predmet = klasa na bazu ne funkiconise ovo puca 
                    // Prostorija i ovo je klasa
