...
namespace DLWMS.Data.IspitIB180079
{
    public class StudentiStipendijeIB180079
    {
        ...
        // pohrana = uslov ? sta ako je uslov true : sta ako je uslov false ; 
        public int UkupnoInfo => StipendijaGodina.Godina == DateTime.Now.Year.ToString() ?
            StipendijaGodina.Iznos * DateTime.Now.Month : 
            StipendijaGodina.Iznos * 12;
